	...
	<ul class="bbpcs__summary__list">
		...
		<span class="bbpcs__summary__list__item__title">
			...
			<span class="bbpcs__summary__list__item__version">
				<?php echo get_post_meta( get_the_ID(), 'bbpcs_support_wp_version', true ) ?>
			</span>
		...
		<li class="bbpcs__summary__list__item bbpcs__summary__list__item--php_version">
			...
			<span class="bbpcs__summary__list__item__version">
				<?php echo get_post_meta( get_the_ID(), 'bbpcs_support_php_version', true ) ?>
			</span>
		...
		<li class="bbpcs__summary__list__item bbpcs__summary__list__item--theme_name">
			...
			<span class="bbpcs__summary__list__item__version">
				<?php echo get_post_meta( get_the_ID(), 'bbpcs_support_theme_name', true ) ?>
			</span>
		</li>
		<li class="bbpcs__summary__list__item bbpcs__summary__list__item--theme_uri">
			...
			<span class="bbpcs__summary__list__item__version">
				<?php echo get_post_meta( get_the_ID(), 'bbpcs_support_theme_uri', true ) ?>
			</span>
		</li>
		<li class="bbpcs__summary__list__item bbpcs__summary__list__item--plugins">
			...
			<span class="bbpcs__summary__list__item__version">
				<?php echo get_post_meta( get_the_ID(), 'bbpcs_support_plugins', true ) ?>
			</span>
		</li>
		<li class="bbpcs__summary__list__item bbpcs__summary__list__item--host">
			...
			<span class="bbpcs__summary__list__item__version">
				<?php echo get_post_meta( get_the_ID(), 'bbpcs_support_host', true ) ?>
			</span>
		</li>
		<li class="bbpcs__summary__list__item bbpcs__summary__list__item--uri">
			...
			<span class="bbpcs__summary__list__item__version">
				<?php echo get_post_meta( get_the_ID(), 'bbpcs_support_uri', true ) ?>
			</span>
		</li>
	</ul>
</div>
